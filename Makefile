...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/libplanner-1.pc.in $(top_srcdir)/configure AUTHORS \
...
CONFIG_CLEAN_FILES = libplanner-1.pc
...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = po libplanner src data docs examples tests python \
	eds-backend
...
abs_builddir = /home/zms/workspace/Plannerbinxy
abs_srcdir = /home/zms/workspace/Plannerbinxy
...
libplanner-1.pc: $(top_builddir)/config.status $(srcdir)/libplanner-1.pc.in
