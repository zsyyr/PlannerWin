...
window_add_stock_icons (void)
{
	...
	/*Auto assignment*/
	window_add_stock_icon (icon_factory,
				       "planner-stock-auto-assignment",
				       "24_auto_assignment.png");
	/*Pert Chart*/
	window_add_stock_icon (icon_factory,
					       "planner-stock-pert-chart",
					       "24_pert_chart.png");
...
window_populate (PlannerWindow *window)
{
	...
	priv->views = g_list_append (priv->views, planner_show_view_new ());
	priv->views = g_list_append (priv->views, planner_review_view_new ());
