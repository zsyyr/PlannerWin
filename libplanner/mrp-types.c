...
GType
mrp_task_type_get_virtual_type (void)
{
	static GType etype = 0;
	if (etype == 0) {
		static const GEnumValue values[] = {
			{ MRP_TASK_TYPE_ACTUAL, "MRP_TASK_TYPE_ACTUAL", "actual" },
			{ MRP_TASK_TYPE_VIRTUAL,"MRP_TASK_TYPE_VIRTUAL","virtual"},
			{ 0, NULL, NULL }
		};
		etype = g_enum_register_static ("MrpTaskVirtualType", values);
	}
	return etype;
}
